...
**[Cognitive ML](https://github.com/caesaranyogu/cognitive-ml)** — Machine learning models built from scratch to model human cognition to produce predictions of human behavior.
...
- Mathematical foundations of ML (linear algebra, calculus, probability)
- PyTorch and NumPy from scratch implementations
- GPU architecture and CUDA fundamentals

## Connect

- [LinkedIn](https://www.linkedin.com/in/caesaranyogu/)
- caesar.anyogu@gmail.com
